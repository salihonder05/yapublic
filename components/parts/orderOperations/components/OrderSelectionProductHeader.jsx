...
const OrderSelectionProductHeader = ({ product }) => {
  return (
    <div className="flex flex-col p-1 rounded-md sm:flex-row bg-ya-dark-white-1">
...
export default OrderSelectionProductHeader;
