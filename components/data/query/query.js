...
const getCityRestaurants = async () => {
    ...
    try {
        const response = await fetch("http://yapublic.vercel.app/api/cityrestaurant", {
            method: "POST",
            headers: {
...
const getRestaurantsProducts = async (accountId) => {
    try {
        const response = await fetch(
            "http://yapublic.vercel.app/api/accountproducts",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
...
const getSingleOrder = async (orderId) => {
    try {
        const response = await fetch(
            "http://yapublic.vercel.app/api/order",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
...
const getProductMenus = async (productId, setProductStatesMenus) => {
    try {
        const response = await fetch(
            "http://yapublic.vercel.app/api/productmenus",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
...
const getUserOrders = async (customerId) => {
    try {
        const response = await fetch(
            "http://yapublic.vercel.app/api/orders",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
...
const getNeighborhoodRestaurants = async (selectedNeighbourhood) => {
    try {
        const response = await fetch(
            "http://yapublic.vercel.app/api/neighborhoodrestaurants",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
...
const getSingleProduct = async (productId, accountId, cartProducts) => {
    try {
        const response = await fetch(
            "http://yapublic.vercel.app/api/singleproduct",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
