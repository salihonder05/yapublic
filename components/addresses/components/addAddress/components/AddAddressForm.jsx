    ...
    <div>
      ...
      <div className="grid grid-cols-1 mt-4 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
        <div className="sm:col-span-2">
          <YaFormInput
            value={createAddressState?.addressName}
        ...
        <div className="sm:col-span-2">
          <YaFormInput
            value={createAddressState?.addressPhone}
            handleOnChange={inputHandler}
            name="addressPhone"
        ...
        <div className="sm:col-span-2">
          <YaFormInput handleOnChange={inputHandler} title={"Cd. Sk. No."} />
        </div>
        ...
        <div className="sm:col-span-2">
          <YaFormInput
            value={createAddressState?.addressText}
            handleOnChange={inputHandler}
            name="addressText"
            title={"ADRES TARİFİ"}
          />
